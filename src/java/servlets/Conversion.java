...
public class Conversion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<body>");
        out.println("<center>");
        out.println("<h1>TU CONVERSION A MONEDA LOCAL   ¡</h1>");
        
        double moneda = Double.parseDouble(request.getParameter("pesos"));
        ...
        out.println("<h2>"+moneda+"</h2>");
        out.println("<br><button type='submit' value='enviar'>VOLVER</button>");
        out.println("</form>");
